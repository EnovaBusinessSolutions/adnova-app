    ...
    async (params, extra) => {
      try {
        ...
        if (params.channel === 'all') {
          const results = [];
          try {
            results.push(await resolveAdPerformance(userId, 'meta', params.date_from, params.date_to, gran));
          } catch {}
          try {
            results.push(await resolveAdPerformance(userId, 'google', params.date_from, params.date_to, gran));
          } catch {}
