...
const CoverageSchema = new Schema(
  {
    ...
    effectiveGranularity: { type: [String], default: [] },
    defaultSignalSchema: { type: String, default: null },
  },
  { _id: false }
);
...
const SignalArtifactSchema = new Schema(
  {
    ...
    payloadSections: { type: [String], default: [] },
    payloadStats: { type: Schema.Types.Mixed, default: null },
    payloadHealth: { type: Schema.Types.Mixed, default: null },
  },
  { _id: false }
);
...
const McpDataSchema = new Schema(
  {
    ...
    grain: { type: String, default: null },
  ...
  return this.findOneAndUpdate(
    { userId, kind: 'root', 'aiContext.signal.generationId': generationId },
    {
      $set: {
        ...
        'aiContext.signal.schemaName': schemaName,
        'aiContext.signal.schemaVersion': schemaVersion,
        'aiContext.signal.payloadSections': Array.isArray(payloadSections) ? payloadSections : [],
        'aiContext.signal.payloadStats': payloadStats,
        'aiContext.signal.payloadHealth': payloadHealth,
        'aiContext.signal.sourceFingerprint': sourceFingerprint,
        'aiContext.signal.sourcesSnapshot': cleanUndefined(sourcesSnapshot),
        'aiContext.signal.snapshotId': snapshotId,
