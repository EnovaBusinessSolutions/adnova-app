...
exports.GOOGLE_ADS_ERRORS = exports.META_PIXEL_ERRORS = exports.GTM_ERRORS = exports.GA4_ERRORS = void 0;
exports.getErrorDetails = getErrorDetails;
exports.getErrorsDetails = getErrorsDetails;
/**
...
function getErrorDetails(errorCode) {
    return (exports.GA4_ERRORS[errorCode] ||
        exports.GTM_ERRORS[errorCode] ||
        exports.META_PIXEL_ERRORS[errorCode] ||
        exports.GOOGLE_ADS_ERRORS[errorCode] ||
        null);
}
/**
 * Obtiene todos los detalles de errores de una lista
 */
function getErrorsDetails(errorCodes) {
    return errorCodes
