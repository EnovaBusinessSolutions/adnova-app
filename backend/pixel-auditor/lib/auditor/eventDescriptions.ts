...
export interface EventDetail {
  ...
  title: string;
  description: string;
  expectedParams: ParamDetail[];
  bestPractices: string[];
  platform: 'GA4' | 'GTM' | 'MetaPixel' | 'all';
}
 ...
 */
export const META_PIXEL_EVENTS: Record<string, EventDetail> = {
  PageView: {
    name: 'PageView',
    category: 'standard',
    title: 'Página Vista',
 ...
 */
export const GA4_EVENTS: Record<string, EventDetail> = {
  page_view: {
    name: 'page_view',
    category: 'standard',
    title: 'Página Vista',
 ...
 */
export const GTM_EVENTS: Record<string, EventDetail> = {
  'gtm.js': {
    name: 'gtm.js',
    category: 'standard',
    title: 'GTM Cargado',
 ...
 */
export function getEventDetails(eventName: string, platform: 'GA4' | 'GTM' | 'MetaPixel'): EventDetail | null {
  switch (platform) {
    case 'GA4':
      return GA4_EVENTS[eventName] || null;
    case 'GTM':
      return GTM_EVENTS[eventName] || null;
    case 'MetaPixel':
      return META_PIXEL_EVENTS[eventName] || null;
    default:
      return null;
  }
}
 ...
 */
export function analyzeEventParams(
  eventName: string,
  platform: 'GA4' | 'GTM' | 'MetaPixel',
