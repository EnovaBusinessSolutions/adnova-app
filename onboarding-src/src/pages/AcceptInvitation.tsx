...
const ERROR_MESSAGES: Record<string, string> = {
  NEEDS_LOGIN: 'You need to sign in to accept the invitation.',
  INVITATION_NOT_FOUND: 'This invitation does not exist or the link is invalid.',
  INVITATION_EXPIRED: 'This invitation has expired. Ask the person who invited you to send a new one.',
  INVITATION_REVOKED: 'This invitation was revoked.',
  INVITATION_DECLINED: 'This invitation was already declined.',
  INVITATION_ALREADY_ACCEPTED: 'This invitation was already accepted.',
  EMAIL_MISMATCH: 'Your email does not match the invitation. Sign out and sign in with the correct account.',
  WORKSPACE_NOT_FOUND: 'The workspace you were invited to no longer exists.',
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        const message = ERROR_MESSAGES[code] || "We couldn't process the invitation. Try again.";
      ...
      <div className="relative z-10 max-w-md w-full text-center space-y-4">
        {result.status === 'loading' && (
          <div className="glass-effect-strong p-6 rounded-2xl space-y-4">
            ...
            <h1 className="text-xl font-semibold text-foreground">Processing invitation…</h1>
            <p className="text-sm text-muted-foreground">This takes a couple of seconds.</p>
          </div>
        )}
        ...
        {result.status === 'success' && (
          <div className="glass-effect-strong p-6 rounded-2xl space-y-4">
            ...
            <h1 className="text-xl font-semibold text-foreground">Welcome to the workspace!</h1>
        ...
        {result.status === 'error' && (
          <div className="glass-effect-strong p-6 rounded-2xl space-y-4">
            ...
            <h1 className="text-xl font-semibold text-foreground">We couldn't accept the invitation</h1>
